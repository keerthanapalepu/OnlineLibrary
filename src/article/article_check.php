...
<html lang="en">
  ...
  <div class="topnav">
    ...
    if ($_POST['SUBMIT'] == 'ADD'){
        ...
        //Create Insert query 
        $query = "INSERT INTO `articles`(`ARTICLE_ID`, `TOPIC`, `WRITTER`, `FILENAME`, `PATH`) VALUES ('$article_id','$article_name','$writter','$filename','$path')"; 
        //Execute query 
    ...
    ?>
    <center><button type='submit' id='GoBack' onclick="location.href='add_article.php'">ADD AGAIN</button></center>
</body>
</html>