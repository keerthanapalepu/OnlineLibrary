  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <div>
        ...
        <center><table> 
            <thead style="color : white; background-color: black;  border: 1px solid black;"> 
                <tr>
                    <th> ARTICLE ID </th>
                    <th> TOPIC </th>
                    <th> WRITTER </th>
        ...
        { ?>
            <tr style="text-aligment : center ;"> 
                <td> <center><?php echo $row["ARTICLE_ID"]; ?></center> </td> 
                <td> <center><?php echo $row["TOPIC"]; ?></center> </td> 
                <td> <center><?php echo $row["WRITTER"]; ?></center> </td> 
                <td> <center><button class="button"> <a href="del_article.php?id=<?php echo $row["ARTICLE_ID"]; ?>" style="text-decoration: none; 
