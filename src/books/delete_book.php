      ...
      <div>
        ...
        <center><table> 
            <thead> 
                <tr style="color : white; background-color: black; border: 1px solid black;">
                    <th style="margin-left : 0px;"> BOOKID </th>
                    <th style="margin-left : 0px;"> BOOKNAME </th>
                    <th style="margin-left : 0px;"> AUTHOR </th>
                    <th style="margin-left : 0px;"> ACTION </th>
                </tr>
            </thead>
        <?php
        ...
        { ?>
            <tr> 
                ...
                <td> <center><button class="button"> <a href="del_book.php?id=<?php echo $row["BOOKID"]; ?>" style="text-decoration: none; 
