...
<html lang="en">
  ...
  <div class="topnav">
    ...
    if ($_POST['SUBMIT'] == 'ADD'){
        ...
        //Create Insert query 
        $query = "INSERT INTO books(`BOOKID`, `BOOKNAME`, `AUTHOR`, `FILENAME`, `PATH_pdf`, `PATH_photo`) VALUES ('$book_id','$book_name','$book_author','$filename','$path_pdf','$path_photo')"; 
        //Execute query 
    ...
    ?>
    <center><button type='submit' id='GoBack' onclick="location.href='add_book.php'">ADD AGAIN</button></center>
</body>
</html>